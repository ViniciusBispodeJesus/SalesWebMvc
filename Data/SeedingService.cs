...

{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if(_context.Department.Any() || _context.Seller.Any() || _context.SallesRecords.Any())
            {
                return;
            }
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 2220.0, new DateTime(1988, 1, 15), d1);
